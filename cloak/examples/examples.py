...
from cloak.utils.helpers import get_contract_names
...
empty_normalized = f'pragma zkay >= {cfg.cloak_version} ; contract Empty {{ }} '
simple_storage_normalized = f'pragma zkay >= {cfg.cloak_version} ; contract SimpleStorage {{ ' \
                            'uint @ all storedData ; ' \

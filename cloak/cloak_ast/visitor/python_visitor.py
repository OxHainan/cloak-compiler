...
from cloak.cloak_ast.ast import CodeVisitor, Block, IndentBlock, IfStatement, indent, ReturnStatement, Comment, \
    ...
    ConstructorOrFunctionDefinition, Parameter, AllExpr, MeExpr, TeeExpr, AnnotatedTypeName, ReclassifyExpr, Identifier, \
...
class PythonCodeVisitor(CodeVisitor):
    ...
    def visitTeeExpr(self, _: TeeExpr):
        raise ValueError("Tee expressions are not supported for python generation")

...
from cloak.cloak_ast.ast import BooleanLiteralExpr, RequireStatement, Identifier, IdentifierExpr, AssignmentStatement, \
    BuiltinFunction, FunctionCallExpr, NumberLiteralExpr


class TestASTSimpleStorageDetailed(CloakTestCase):
